...
// import FormLinkPopup from '../link-popup/FormLinkPopup';

// const PublishPopup = ({ onClose, formId }) => {
...
//             try {
//                 const res = await axios.get(`http://localhost:5000/api/forms/${formId}/owner-email`);
...
//     //                 email,
//     //                 access: emailActions[idx] || 'view' // default to view if not set
//     //             }));

//     //             await axios.post(
//     //                 `http://localhost:5000/api/forms/form/${formId}/share`,
...
//     //         }
//     //     } else {
//     //         // Handle "Anyone with the link" logic if needed
//     //         onClose();
//     //     }
//     // };
...
//             setShowLinkPopup(true); // Show link popup instead of closing
//         }
//     };
...
//                                         }
//                                     >
//                                         {/* {emailActions[idx] === 'share' ? 'Share' : 'Edit'} */}
...
//                                             <div
//                                                 onClick={() => {
//                                                     // You can handle edit action here if needed
...
//                 <FormLinkPopup
//                     formId={formId}
//                     onClose={onClose} // closes popup after clicking Done
//                 />
//             )}
//         </div>
//     );
